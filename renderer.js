window.addEventListener("DOMContentLoaded", () => {
  ...
  function werdeAelter() {
      ...
      if (lebtStatus) {
          ...
          let vergangeneSekunden = vergangeneZeitInMillisekunden / window.electron.jahresDauer; // Umrechnung in Jahre
          document.getElementById("alter").innerText = vergangeneSekunden.toFixed(0);
      }
